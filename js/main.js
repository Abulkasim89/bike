...
function valid(){
	...
	var secondname = document.getElementById('email').value;
	var thirdname = document.getElementById('phone').value;
	var fourthname = document.getElementById('subject').value;
	var fifthname = document.getElementById('message').value;
...
Swal.fire({
	...
	else (fifthname.length == 30,
		secondname.length == 20,
		thirdname.length == 12,
		fourthname.length == 100,
		fifthname.length == 100
